...
\begin{frame}{Spatial proteomics - How, experimentally}
  \begin{figure}
    \includegraphics[width=.8\linewidth]{figs/F02-expdesigns.pdf}
...
\begin{frame}{}
  \begin{figure}
    % \includegraphics[width=.8\linewidth]{figs/F03-protocols-8plex.pdf}
    % \includegraphics[width=.5\linewidth]{figs/expdesign.pdf}
    \includegraphics[width=.39\linewidth]{figs/workflow_primary.pdf}
  \end{figure}
\end{frame}
